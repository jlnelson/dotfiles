...
augroup javascript_autocmd
  ...
  autocmd FileType javascript set formatoptions=tcq2l
  autocmd FileType javascript set textwidth=78 shiftwidth=4
  autocmd FileType javascript set softtabstop=4 tabstop=4
